...
public class AppRater {
    ...
    private final static String APP_TITLE = "Aptitude Quiz";// App Name
    private final static String APP_PNAME = "app.aptitude.quiz.craftystudio.aptitudequiz";// Package Name
